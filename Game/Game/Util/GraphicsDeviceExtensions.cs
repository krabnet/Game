...
public static class GraphicsDeviceExtensions
{
    ...
    public static void PrepareScreenShot(this GraphicsDevice device)
    {
        ...
        //{
            ...
            //List<RenderTargetBinding> RTs = new List<RenderTargetBinding>();
            //RTs.Add(new RenderTarget2D(device, device.PresentationParameters.BackBufferWidth, device.PresentationParameters.BackBufferHeight, false, SurfaceFormat.Color, DepthFormat.None, 0, RenderTargetUsage.PreserveContents));
            //RTs.Add(null);
            //device.SetRenderTargets(RTs.ToArray());
            //device.SetRenderTarget(new RenderTarget2D(device, device.PresentationParameters.BackBufferWidth, device.PresentationParameters.BackBufferHeight, false, SurfaceFormat.Color, DepthFormat.None, 0, RenderTargetUsage.PreserveContents));
