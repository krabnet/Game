...
namespace Game.Items.Types
{
    public class TestChest
    {
        public Game.Objects.Sprite2d Get(Items.Item.ItemType IT, Vector2 Position)
        {
            ...
            ReturnSprite.Inventory.Add(Item.GetItemByType(Item.ItemType.Hammer, Util.Global.DefaultPosition).Item);
            ReturnSprite.Inventory.Add(Item.GetItemByType(Item.ItemType.Pickaxe, Util.Global.DefaultPosition).Item);
            ReturnSprite.Inventory.Add(Item.GetItemByType(Item.ItemType.Torch, Util.Global.DefaultPosition).Item);
            ReturnSprite.Inventory.Add(Item.GetItemByType(Item.ItemType.PotionSpeed, Util.Global.DefaultPosition).Item);
            ReturnSprite.Inventory.Add(Item.GetItemByType(Item.ItemType.PotionStrength, Util.Global.DefaultPosition).Item);
            ReturnSprite.Inventory.Add(Item.GetItemByType(Item.ItemType.PotionDexterity, Util.Global.DefaultPosition).Item);
